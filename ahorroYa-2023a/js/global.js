...
var $passwordIcons = $('.password-icons');
	$passwordIcons.on('click', function(){
		var $iconEyeHiden = $(this).find('.icon-eye.hiden')
		var $iconEyeShow = $(this).find('.icon-eye.show')
		var $passwordInput = $(this).siblings('.password')[0]
		$iconEyeHiden.removeClass('hiden')
		$iconEyeHiden.addClass('show')
		$iconEyeShow.removeClass('show')
		$iconEyeShow.addClass('hiden')
